...
# Falls v2.0.81 bei probutus nicht existiert, durch Commit-Hash ersetzen, z.B.:
# MINISATIP_VERSION = abc123def456...

MINISATIP_SITE = $(call github,probutus,minisatip,$(MINISATIP_VERSION))
MINISATIP_LICENSE = GPL-2.0
MINISATIP_LICENSE_FILES = LICENSE

# Abhängigkeiten für den Buildprozess
MINISATIP_DEPENDENCIES = openssl libbacktrace

# CMake-Konfigurationsoptionen
MINISATIP_CONF_OPTS = \
	-DENABLE_STACKTRACE=OFF \
	-DCMAKE_CXX_STANDARD=23 \
	-DCMAKE_CXX_FLAGS="$(TARGET_CXXFLAGS)" \
	-DCMAKE_EXE_LINKER_FLAGS="-lstdc++exp -lbacktrace"

# ACHTUNG: Die folgenden Zeilen MÜSSEN mit einem TAB eingerückt sein!
